...
public class Main2 {
    public static void main(String[] args) {
        ...
        Purchase p2 = new Purchase("Nike Soccer Ball", 2, 50);
        Purchase p3 = new Purchase("Adidas Jersey", 1, 100);
        Purchase p4 = new Purchase("Puma Shorts", 3, 75);
        Purchase p5 = new Purchase(p3);
        Purchase p6 = p2.makeCopy();
        Purchase p7 = new Purchase("Nike Cleats", 4, 200);
        ...
        System.out.println("Item Name: " + p2.getItemName() + " Quantity: " + p2.getQuantity() + " Price: " + p2.getItemPrice() + " Total Cost: " + p2.getItemPrice() * p2.getQuantity() + "\n");
        ...
        if (p2.equals(p3)) {
            System.out.println("Purchase 1 and Purchase 2 are equal\n");
        } else {
            System.out.println("Purchase 1 and Purchase 2 are not equal\n");
        }
        if (p3.equals(p5)) {
            System.out.println("Purchase 2 and Purchase 4 are equal\n");
        } else {
            System.out.println("Purchase 2 and Purchase 4 are not equal\n");
        }
        ...
        lstt4.add(new Purchase("Box", 8, 55.60));
        lstt4.add(new Purchase("Scale", 15, 7.5));

        // altering lstt 2
        lstt2.add(lstt4);
        Purchase removed = lstt2.remove("Pen");
        if (removed == null)
            System.out.println(removed.getItemName() + " item not found!\n");
        else
            System.out.println(removed.getItemName() + " is removed!\n");
        ...
        System.out.println("Puchases in lstt 2:\nNumber of Purchase: " +
                lstt2.getLength() + "\n");
        ...
        System.out.println("Puchases in lstt 3:\nNumber of Purchase: " +
                lstt3.getLength() + "\n");
        ...
        System.out.println("Puchases in lstt 4:\nNumber of Purchase: " +
                lstt4.getLength() + "\n");
        ...
        if (lstt.equals(lstt2)) {
            System.out.println("Purchase lstt 1 and Purchase lstt 2 are equal\n");
        } else {
            System.out.println("Purchase lstt 1 and Purchase lstt 2 are not equal\n");
        }
        if (lstt.equals(lstt3)) {
            System.out.println("Purchase lstt 1 and Purchase lstt 3 are equal\n");
        } else {
            System.out.println("Purchase lstt 1 and Purchase lstt 3 are not equal\n");
        }
